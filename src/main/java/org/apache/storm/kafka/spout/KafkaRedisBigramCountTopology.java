 ...
 */
public class KafkaRedisBigramCountTopology {

    private static final String TOPIC_0_STREAM = "topic_0_stream";
    private static final String KAFKA_LOCAL_BROKER = "localhost:9092";
    public static final String TOPIC_0 = "bigram-topic";

    public static void main(String[] args) throws Exception {
        new KafkaRedisBigramCountTopology().runMain(args);
    }
    ...
    protected void runMain(String[] args) throws Exception {
        ...
        StormSubmitter.submitTopology("bigrams", tpConf, getTopologyKafkaSpout(getKafkaSpoutConfig(brokerUrl)));
    }
    ...
    protected StormTopology getTopologyKafkaSpout(KafkaSpoutConfig<String, String> spoutConfig) {
        ...
        tp.setBolt("SplitBolt", new SplitSentence(), 8).shuffleGrouping("KafkaSpout", TOPIC_0_STREAM);
        tp.setBolt("StormCountBolt", new WordCountBolt(), 12).fieldsGrouping("SplitBolt", new Fields("word"));
